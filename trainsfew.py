...
def parse_args():
    ...
    parser.add_argument("--save_prefix", type=str, default="sfew", help="Checkpoint filename prefix")
...
def run_training():
    ...
    # Convert grayscale images to RGB so pretrained backbones still work with 3 channels.
